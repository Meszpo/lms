...
// a computed with no reactive dependencies, so a plain const is equivalent.
		...
		items: [
			{
				label: 'Accounts',
				description:
					'Manage email accounts for incoming and outgoing mail',
				icon: 'lucide-mail',
								...
								fields: [
									{
										...
										type: 'checkbox',
										description:
											'Show the Courses link in the sidebar.',
									},
									{
										label: 'Batches',
										name: 'batches',
										type: 'checkbox',
										description:
											'Show the Batches link in the sidebar.',
									},
									{
